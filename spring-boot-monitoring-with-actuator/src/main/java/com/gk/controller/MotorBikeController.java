...
public class MotorBikeController {
	...
	public ResponseEntity<MotorBike> saveMotorBike(@Valid @RequestBody final MotorBike motorBike) {// @valid is to check
																									// for the request
																									// validations. i.e.
																									// to check if the
																									// data is coming
		...
		URI location = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}")
				.buildAndExpand(savedMotorBike.getBikeId()).toUri();
