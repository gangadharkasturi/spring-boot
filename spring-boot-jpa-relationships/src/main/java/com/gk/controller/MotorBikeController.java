...
public class MotorBikeController {
	...
	@GetMapping(value="/person/{id}/motorBikes")
	public List<MotorBike> getAllMotorBikesOfPerson(@PathVariable final int id){
		Optional<Person> person = repo.findById(id);
		if(!person.isPresent())
			throw new RuntimeException();
		return person.get().getMotorBikes();
	}
